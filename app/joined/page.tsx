    ...
    <div>
      ...
      <OrgDetailDialog
        org={{
          ...
          description: 'Harvard Tech for Social Good (T4SG) leverages Harvard talent to partner with nonprofits, government agencies, and social impact organizations to amplify their impact through technology. Students can develop their expertise in software engineering, user experience, and ethics through semester-long projects with real-world clients.',
